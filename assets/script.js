...
//set width of array and individual element
...
//create array with random values within range
...
//set all values according to input
$(document).ready(function() {
    ...
    //create new array on clicking random button
    $("#randomize").click(
        function() {
            createArray();
        }
